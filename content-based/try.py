# -*- coding: utf-8 -*-
"""
Created on Sat May  4 21:06:18 2019
...
for i in data['Alldata']:
    ...
    clean_data = [lemmatizer.lemmatize(word) for word in clean_data if not word in stopwords.words('english')]
...
model2 = Word2Vec(doc, min_count = 1, size = 300,window = 6, sg = 1)         
print(model2)
...
t = []
for i in titles:
     i = re.sub('[(\xa0)(\xa0\xa0)(ÃÂÃÂ)(Ã\x82Â\xa0Ã\x82Â\xa0)]','',i)
     t.append(i)
